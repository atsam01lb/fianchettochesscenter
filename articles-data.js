const FIANCHETTO_ARTICLES = [
  ...
  excerpt: 'Fianchetto Chess Center collaborated with Nahnoo Association on a two-day social chess event featuring educational sessions, a friendly tournament, and chess-based activities.',
  images: ['article23-1.jpg', 'article23-2.jpg', 'article23-3.jpg', 'article23-4.jpg', 'article23-5.jpg', 'article23-6.jpg', 'article23-7.jpg'],
  body: `
    <p>Fianchetto Chess Center, in collaboration with <strong>Nahnoo Association</strong>, organized a two-day social chess event that brought together players and chess enthusiasts for an engaging community experience.</p>

    <p>The event featured a variety of activities, including <strong>educational chess sessions, a friendly tournament, and several chess-based games</strong>, creating an environment that combined learning, competition, and social interaction.</p>

    <h3>Bringing Chess Communities Together</h3>

    <p>A delegation of Fianchetto Chess Center players from North Lebanon participated in the event alongside a <strong>Palestinian team from the chess school at Shatila Camp</strong>. A number of participants from the Beirut community also joined the activities.</p>

    <p>The gathering provided players from different communities with an opportunity to meet, compete, exchange experiences, and connect through their shared passion for chess.</p>

    <h3>Friendly Tournament</h3>

    <p>The two-day event concluded with an awards ceremony recognizing the top performers in the friendly chess tournament.</p>

    <p>The event represented another successful community initiative for Fianchetto Chess Center, highlighting the role of chess in education, social interaction, and building connections between players from different backgrounds.</p>

    <p>We look forward to continuing this collaboration and organizing more chess activities and community initiatives in the future.</p>
  `
},
  {
